...
if __name__ == "__main__":
    ...
    def callback3():
        webbrowser.open_new(r"yes.edu.in")


    def callback():
        webbrowser.open_new(r"https://docs.google.com/spreadsheets/d/12ChOne_SNfuCw5POTNovvmP659tfLyUv6TRHLF8ztq0/edit?resourcekey#gid=1661750625")

    def callback1():
        webbrowser.open_new(r"C:\Users\Admin\PycharmProjects\pythonProject3\qrcode.png")
    ...
    link = Link_Button(frame, text="Open QR Code", action=callback1)

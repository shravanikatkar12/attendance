...
def openNewWindow():
    ...
    if __name__ == "__main__":
        ...
        def callback():
            webbrowser.open_new(
                r"https://docs.google.com/spreadsheets/d/12ChOne_SNfuCw5POTNovvmP659tfLyUv6TRHLF8ztq0/edit?resourcekey#gid=1661750625")
        ...
        class Form(tkinter.Frame):
            ...
            def initialize_interface(self):
                ...
                self.labelUser = tkinter.Label(self.parent, text="Username: ", background="dark slate gray",
                                               foreground="White",
                                               font="Arial 8 bold")
                ...
                self.labelPass = tkinter.Label(self.parent, text="Password: ", background="dark slate gray",
                                               foreground="White",
                                               font="Arial 8 bold")
                ...
                self.buttonLogin = tkinter.Button(self.parent, text="LOGIN", font="Arial 8 bold", command=callback3)
